...
- language: `ar`, `en`, `fa`, `ps`, `ru`, `tg`, `ug`, `uk`, `ur`, `uz`
- whitespace-token length: 1, 2, 3, 5, 10, 20, 50, 100

The core FLORES matrix produces 400 cases. Another 40 native Cyrillic Uzbek
...
suite therefore has 600 cases. Do not use this file to train or tune the
